...
{
    public class GenericTableColumnsWrap : ITableColumnsWrap
    {
        private TableRow genericTableRow;    //either table OR tableColumnsInfo
        
        public GenericTableColumnsWrap(TableRow gtr)
        {
