...
namespace EM.DB
{
    ...
    /// </summary>
    public class SqlServerDBWorkerOneConnection : BaseDBWorker, IDisposable
    {
        protected SqlConnection sqlConn; 
        public SqlServerDBWorkerOneConnection(): base() { }
        public SqlServerDBWorkerOneConnection(string connStr): base(connStr) {}
        public SqlServerDBWorkerOneConnection(EDictionary<string, string> config): base(config)  {}
        public SqlServerDBWorkerOneConnection(SqlConnection conn)
        {
            this.sqlConn = conn;
