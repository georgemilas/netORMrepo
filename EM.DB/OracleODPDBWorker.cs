...
namespace EM.DB
{
    ...
    /// </summary>
    public class OracleODPDBWorker : BaseDBWorkerConnectionPerCommand, IDisposable
    {
        protected OracleConnection sqlConn; 
        public OracleODPDBWorker(): base() { }
        public OracleODPDBWorker(string connStr): base(connStr) {}
        public OracleODPDBWorker(EDictionary<string, string> config): base(config)  {}
        public OracleODPDBWorker(OracleConnection conn)
        {
            this.sqlConn = conn;
